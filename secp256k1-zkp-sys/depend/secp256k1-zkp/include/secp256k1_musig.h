...
typedef struct {
    ...
    int is_negated;
} secp256k1_zkp_musig_pre_session;
...
SECP256K1_API int secp256k1_zkp_musig_pubkey_combine(
    ...
    secp256k1_zkp_xonly_pubkey *combined_pk,
    secp256k1_zkp_musig_pre_session *pre_session,
    const secp256k1_zkp_xonly_pubkey *pubkeys,
    size_t n_pubkeys
...
SECP256K1_API int secp256k1_zkp_musig_session_initialize(
    ...
    const secp256k1_zkp_xonly_pubkey *combined_pk,
    const secp256k1_zkp_musig_pre_session *pre_session,
    size_t n_signers,
    size_t my_index,

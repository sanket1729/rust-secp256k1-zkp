 ...
 *  To be used to initialize stack-allocated secp256k1_zkp_surjectionproof struct
 ...
 *
 * In:               ctx: pointer to a context object
 *           proof_out_p: a pointer to a pointer to `secp256k1_zkp_surjectionproof*`.
 ...
 *          input_index: The index of the actual input that is secretly mapped to the output
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_zkp_surjectionproof_allocate_initialized(
        const secp256k1_zkp_context* ctx,
        secp256k1_zkp_surjectionproof** proof_out_p,
        size_t *input_index,
        const secp256k1_zkp_fixed_asset_tag* fixed_input_tags,
        const size_t n_input_tags,
        const size_t n_input_tags_to_use,
 ...
 *  deallocates the struct that was allocated with secp256k1_zkp_surjectionproof_allocate_initialized
 *
 * In:               proof: pointer to secp256k1_zkp_surjectionproof struct
 */
SECP256K1_API void secp256k1_zkp_surjectionproof_destroy(
        secp256k1_zkp_surjectionproof* proof

...
static int secp256k1_zkp_selftest_sha256(void) {
    ...
    secp256k1_zkp_sha256_write(&hasher, (const unsigned char*)input63, 63);
    secp256k1_zkp_sha256_finalize(&hasher, out);
    return secp256k1_zkp_memcmp_var(out, output32, 32) == 0;
}

static int secp256k1_zkp_selftest(void) {
    return secp256k1_zkp_selftest_sha256();
}

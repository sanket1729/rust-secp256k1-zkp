...
static SECP256K1_INLINE void secp256k1_zkp_memczero(void *s, size_t len, int flag) {
 ...
 */
static SECP256K1_INLINE int secp256k1_zkp_memcmp_var(const void *s1, const void *s2, size_t n) {
...
static SECP256K1_INLINE void secp256k1_zkp_int_cmov(int *r, const int *a, int flag) {
